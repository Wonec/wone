...
class HairLabel(QtWidgets.QLabel):                                  # 用于显示假发的QLabel类
    def __init__(self, w, h, parent):                               # w, h参数接受宽高 parent接受的是主窗口对象
        ...
        pixmap = QtGui.QPixmap(r'C:\Users\wone\Desktop\PythonCode\PyQt5-Learn\learn\img\假发.png')                    # 加载本地假发png文件
...
class MainWindow(QtWidgets.QWidget):                                # 主窗口 继承自QWidgets
    def __init__(self):
        ...
        pixmap = QtGui.QPixmap(r'C:\Users\wone\Desktop\PythonCode\PyQt5-learn\learn\img\光头.png')                   # 用QPixmap加载本地png图片
        ...
        self.hairLabel = HairLabel(self.hairW, self.hairH, self)    #C: 实例化hairLabel 并将宽高和主窗口对象传给它 将它嵌入主窗口
